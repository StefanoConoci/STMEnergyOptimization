...
int main(int argc, char *argv[]){
        ...
        printf("%d;%lf;%lf;%lf;%lf;%lf;%lf;%lf;%lf;%lf;%lf\n",
                threads, avg_time, avg_commits, avg_aborts, avg_throughput, avg_package_energy, avg_core_energy, avg_dram_energy, avg_package_power, avg_core_power, avg_dram_power);
