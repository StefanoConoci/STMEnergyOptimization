...
int main(int argc, char *argv[]){
        ...
        printf("%d,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf\n",
                threads, avg_time, avg_commits, avg_aborts, avg_throughput, avg_package0_energy, avg_dram0_energy, avg_package1_energy, avg_dram1_energy, avg_package0_power, avg_dram0_power, avg_package1_power, avg_dram1_power);
