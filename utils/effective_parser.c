...
int main(int argc, char *argv[]){
        ...
        printf("Entries: %d - P_state: %lf - Best_threads: %lf - Steps: %lf - Runtime: %lf - Commits: %lf - Aborts: %lf - Throughput: %lf - Energy_per_tx: %lf - Package_power: %lf\n",
                entries, avg_pstate, avg_best_threads, avg_steps, avg_time, avg_commits, avg_aborts, avg_throughput, avg_energy_per_tx, avg_package_power);
