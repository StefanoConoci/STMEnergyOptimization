...
do
	...
	do
		...
		do	
			...
			numactl --physcpubind=+0-19 /home/conoci/git/STMEnergyOptimization/stamp/genome/./genome -g26384 -s64 -n16777216 -t$j >> bench/SBAC-PAD/results/all_config_lock/genome-$i-$j.txt
		done
	done 
done
