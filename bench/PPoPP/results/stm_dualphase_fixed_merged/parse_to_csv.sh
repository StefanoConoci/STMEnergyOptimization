...
printf "intruder,dual," >> heuristics-$1-stm.csv 
./net_stats_parser_csv intruder-$1-stm-dualphase.txt >> heuristics-$1-stm.csv 
...
printf "vacation,dual," >> heuristics-$1-stm.csv 
./net_stats_parser_csv vacation-$1-stm-dualphase.txt >> heuristics-$1-stm.csv 
...
printf "genome,dual," >> heuristics-$1-stm.csv 
./net_stats_parser_csv genome-$1-stm-dualphase.txt >> heuristics-$1-stm.csv 
...
./net_stats_parser_csv ssca2-$1-stm-baseline.txt >> heuristics-$1-stm.csv 

printf "ssca2,dual," >> heuristics-$1-stm.csv 
./net_stats_parser_csv ssca2-$1-stm-dualphase.txt >> heuristics-$1-stm.csv 

printf "ssca2,h0," >> heuristics-$1-stm.csv 
./net_stats_parser_csv ssca2-$1-stm-h0.txt >> heuristics-$1-stm.csv 

printf "ssca2,h1," >> heuristics-$1-stm.csv 
./net_stats_parser_csv ssca2-$1-stm-h1.txt >> heuristics-$1-stm.csv 
