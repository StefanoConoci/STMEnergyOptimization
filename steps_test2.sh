...
do
	...
	stamp/yada/./yada -a30 -i stamp/yada/inputs/ttimeu1000000.2 -t20 -c20 >> bench/Server/steps/yada-3.txt

	./set_profile 5 80 10000 60 7 15 
	stamp/yada/./yada -a30 -i stamp/yada/inputs/ttimeu1000000.2 -t20 -c20 >> bench/Server/steps/yada-7.txt
